...
<script type="application/ld+json">
{
    ...
    if ($latest_posts->have_posts()) : ?>
        <section class="latest-posts" aria-label="Latest beauty insights">
            <div class="section__inner">
                <div class="section__header reveal">
                    <span class="section__label">Beauty Insights</span>
                    <h2 class="section__title">From the Blog</h2>
                    <p class="section__desc">Expert tips, treatment guides, and beauty trends from our team.</p>
                </div>
                <div class="latest-posts__grid reveal">
                    <?php while ($latest_posts->have_posts()) : $latest_posts->the_post(); ?>
                        <a href="<?php the_permalink(); ?>" class="latest-post-card">
                            ...
                            <div class="latest-post-card__body">
                                ...
                                <h3 class="latest-post-card__title"><?php the_title(); ?></h3>
                                <p class="latest-post-card__excerpt"><?php echo wp_trim_words(get_the_excerpt(), 15); ?></p>
                                <span class="latest-post-card__link">Read More →</span>
                            </div>
                        </a>
    ...
    <!-- ═══════════════════════════════════════════════════════════════
         REFER A FRIEND
         ═══════════════════════════════════════════════════════════════ -->
    <section class="refer-section" aria-label="Refer a friend program">
        <div class="section__inner">
            <div class="refer-card reveal">
                <div class="refer-card__content">
                    <span class="refer-card__badge">🎁 Referral Program</span>
                    <h2 class="refer-card__title">Share the Glow,<br>Get Rewarded</h2>
                    <p class="refer-card__text">Refer a friend to Livia Med Spa and you'll both receive <strong>$50 credit</strong> toward any treatment. It's our way of saying thank you for spreading the beauty.</p>
                    <a href="<?php echo esc_url(home_url('/contact/')); ?>" class="btn btn--primary btn--lg">Refer a Friend →</a>
                </div>
                <div class="refer-card__visual" aria-hidden="true">
                    <div class="refer-card__circle refer-card__circle--1">$50</div>
                    <div class="refer-card__circle refer-card__circle--2">$50</div>
                    <div class="refer-card__plus">+</div>
                </div>
            </div>
        </div>
    </section>
