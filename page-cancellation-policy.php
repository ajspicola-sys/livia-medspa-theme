                ...
                <section id="cancellation-policy">
                    ...
                    <div class="cancellation-grid">
                        ...
                        <div class="cancellation-card cancellation-card--danger">
                            <div class="cancellation-card__icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="m4.9 4.9 14.2 14.2"/></svg></div>
                            <div class="cancellation-card__body">
